...
function setCarDataToFields(car) {
    ...
    let frontViewImg = frontViewPath.split("E:\\GDSE 58\\IDE's\\3rd Semester\\Easy-Car-Rental\\Car-Rental-FontEnd\\assets\\savedImages\\Cars\\")[1];
    console.log(frontViewImg)
    let FrontViewImgSrc = "assets\\savedImages\\Cars\\" + frontViewImg;

    let backViewPath = car.backView;
    let backViewImg = backViewPath.split("E:\\GDSE 58\\IDE's\\3rd Semester\\Easy-Car-Rental\\Car-Rental-FontEnd\\assets\\savedImages\\Cars\\")[1];
    let backViewImgSrc = "assets\\savedImages\\Cars\\" + backViewImg;

    let sideViewPath = car.sideView;
    let sideViewImg = sideViewPath.split("E:\\GDSE 58\\IDE's\\3rd Semester\\Easy-Car-Rental\\Car-Rental-FontEnd\\assets\\savedImages\\Cars\\")[1];
    let sideViewImgSrc = "assets\\savedImages\\Cars\\" + sideViewImg;

    let interiorViewPath = car.internalView;
    let interiorViewImg = interiorViewPath.split("E:\\GDSE 58\\IDE's\\3rd Semester\\Easy-Car-Rental\\Car-Rental-FontEnd\\assets\\savedImages\\Cars\\")[1];
