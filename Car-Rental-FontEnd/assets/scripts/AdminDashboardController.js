...
function searchAndLoadCustomerImgs(id) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            let nicFrontImg = nicFrontPath.split("E:\\GDSE 58\\IDE's\\3rd Semester\\Easy-Car-Rental\\Car-Rental-FontEnd\\assets\\savedImages\\Customers\\")[1];
            let nicFrontImgSrc = "assets\\savedImages\\Customers\\" + nicFrontImg;
            console.log(nicFrontImgSrc);

            let nicBackPath = customer.nicBackImg;
            let nicBackImg = nicBackPath.split("E:\\GDSE 58\\IDE's\\3rd Semester\\Easy-Car-Rental\\Car-Rental-FontEnd\\assets\\savedImages\\Customers\\")[1];
            let nicBackImgSrc = "assets\\savedImages\\Customers\\" + nicBackImg;

            let licencePath = customer.licenceImg;
            let licenceImg = licencePath.split("E:\\GDSE 58\\IDE's\\3rd Semester\\Easy-Car-Rental\\Car-Rental-FontEnd\\assets\\savedImages\\Customers\\")[1];
